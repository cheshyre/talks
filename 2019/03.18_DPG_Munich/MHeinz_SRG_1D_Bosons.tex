...
\begin{document}
    ...
    \begin{columns}[c]
      \begin{column}{0.5\textwidth}
        ...
        \begin{itemize}
          ...
          \item Typical choice: $G=T_{rel}$ \visible<1>{(right)}
        \end{itemize}
        \vskip1em
        \visible<2->{Features/Challenges:}
        \begin{itemize}
          \item<2-> Improves many-body convergence
          \item<2-> Induces many-body forces
        \end{itemize}
      \end{column}
      \begin{column}{0.5\textwidth}
        \begin{center}
          \begin{overprint}
            ...
            % \onslide<1>Here $G=T_{rel}$
            % \onslide<2>\includegraphics[width=\textwidth]{figures/03/roth1} \\
            % \onslide<2>{\footnotesize{Roth et al., Phys.Rev.Lett.~107 (2011) 072501}}
            \onslide<2->\includegraphics[width=\textwidth]{figures/03/roth2} \\
            \begin{center}
              \vskip-2em
              \onslide<2->{\footnotesize{Roth \textit{et al.}, Phys.Rev.Lett.~107 (2011) 072501}}
            \end{center}
          \end{overprint}
  ...
  \begin{frame}
    \frametitle{The Negele Model \\ \vskip-0.4em \normalfont \footnotesize{Alexandrou \textit{et al.}, Phys.Rev.~C39 (1989) \\ \vskip-1.8em Jurgenson, Furnstahl, Nucl.Phys.~A818 (2009)}}
    \vskip-2em
    \begin{columns}[c]
      \begin{column}{0.4\textwidth}
        Features:
    ...
    \begin{columns}[c]
      \begin{column}{0.8\textwidth}
        ...
        \begin{itemize}
          ...
          \item Considering generators of form $T + WV_s$ \\ provides an interesting way to explore alternative generators
        \end{itemize}
        \vskip1em
        Direction:
        \begin{itemize}
          \item Extend analysis to 4- and 5-body systems
          \item Learn what features of generators lead to what behavior
          \item Identify features that lead to small four and higher-body forces
        \end{itemize}
        \pause
        \vskip1em
        \begin{center}

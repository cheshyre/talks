  ...
  \begin{frame}
    ...
    \begin{columns}[c]
      ...
      \begin{column}{0.5\textwidth}
        \begin{center}
          \begin{overprint}
            \onslide<1>\includegraphics[width=0.55\textwidth]{figures/03/srg_potentials}
            \onslide<2>\includegraphics[width=\textwidth]{figures/03/roth1}
            \onslide<3->\includegraphics[width=\textwidth]{figures/03/roth2}
          \end{overprint}
          \visible<2->{\small{Roth et al., Phys.Rev.Lett.~107 (2011) 072501}}
        \end{center}
